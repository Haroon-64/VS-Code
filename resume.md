...
* Built ML models to improve heart disease classification accuracy from 80% to 85% with measurable gains in precision and recall.
...
### Animal Classification - Python, TensorFlow, PyQt5, TFLite

* Achieved 97.8% accuracy using transfer learning with MobileNetV2.
* Deployed a desktop app using PyQt5.
